...
export const Footer = () => {
  return (
    <footer className="bg-[#90d4c6] py-16">
      <img src={logo} alt="Icon" className="mx-auto mb-10" />
      <div
        role="socialIcons"
        className="w-[297px] mx-auto flex place-content-between text-dark-desaturated-cyan-text font-semibold text-lg font-fontBarlow mb-[88px]"
      >
      ...
      <div className="flex w-[164px] mx-auto place-content-between">
        <svg
